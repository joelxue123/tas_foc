...
uint32_t myTask03Buffer[ 2048 ];
osStaticThreadDef_t myTask03ControlBlock;
osThreadId myTask04Handle;
uint32_t myTask04Buffer[ 2048 ];
...
int main(void)
{
  ...
  osThreadStaticDef(myTask02, StartTask02, osPriorityIdle, 0, 2048, myTask02Buffer, &myTask02ControlBlock);
  myTask02Handle = osThreadCreate(osThread(myTask02), NULL);

  /* definition and creation of myTask03 */
  osThreadStaticDef(myTask03, StartTask03, osPriorityIdle, 0, 2048, myTask03Buffer, &myTask03ControlBlock);
  myTask03Handle = osThreadCreate(osThread(myTask03), NULL);

  /* definition and creation of myTask04 */
  osThreadStaticDef(myTask04, StartTask04, osPriorityIdle, 0, 2048, myTask04Buffer, &myTask04ControlBlock);
